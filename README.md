...
export IA_DET_PRISON_EMAIL_MAPPINGS='{
  "prisonEmailMappings": {
    ...
    "Bella Centre": "det-prison-blantyre-house@example.com",
    ...
    "Edinburgh": "det-prison-edinburgh-saughton@example.com",
    ...
    "Hatfield (Main site)": "det-prison-hatfield@example.com",
    "Hatfield (Lakes site)": "det-prison-hatfield@example.com",
    "Haverigg": "det-prison-haverigg@example.com",
    "Hewell": "det-prison-hewell-grange@example.com",
    ...
    "Hollesley Bay": "det-prison-hollesley-bay-hmyoi-warren-hill@example.com",
    ...
    "Moorland": "det-prison-moorland-closed@example.com",
    ...
    "Northumberland": "det-prison-northallerton@example.com",
    ...
    "Spring Hill / Grendon": "det-prison-spring-hill@example.com",
...
**Note**: In production, this environment variable is automatically populated from Azure Key Vault (secret: `ia-det-prison-email-mappings`).
