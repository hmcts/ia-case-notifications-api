...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.appellant.email.AiPAppellantRefundRequestedNotificationEmail;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.appellant.email.AipAppellantEditAppealDisposalPersonalisationEmail;
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.appellant.email.AipAppellantManageFeeUpdatePersonalisationEmail;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.appellant.email.AipAppellantRefundConfirmationPersonalisationEmail;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.appellant.email.AipAppellantStartAppealDisposalPersonalisationEmail;
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.appellant.email.AipRemissionRequestAutomaticReminderEmail;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.appellant.email.AppellantRecordRefundDecisionPersonalisationEmail;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.appellant.sms.AiPAppellantRefundRequestedNotificationSms;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.appellant.sms.AipAppellantManageFeeUpdatePersonalisationSms;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.appellant.sms.AipAppellantRefundConfirmationPersonalisationSms;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.appellant.sms.AipRemissionRequestAutomaticReminderSms;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.appellant.sms.AppellantRecordRefundDecisionPersonalisationSms;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.legalrepresentative.LegalRepRefundConfirmationPersonalisation;
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.legalrepresentative.LegalRepRemissionPaymentReminderPersonalisation;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.legalrepresentative.LegalRepresentativeAppealEditedDisposalPersonalisation;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.legalrepresentative.LegalRepresentativeAppealStartedDisposalPersonalisation;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.legalrepresentative.LegalRepresentativeManageFeeUpdateAdditionalPaymentPersonalisation;
...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.legalrepresentative.LegalRepresentativeRecordAdjournmentDetailsPersonalisation;
...
public class NotificationGeneratorConfiguration {
    ...
    public List<NotificationGenerator> forceCaseProgressionNotificationGenerator(
        ...
        return singletonList(new EmailNotificationGenerator(
            newArrayList(homeOfficePersonalisation,
    ...
    public List<NotificationGenerator> editDocumentsNotificationGenerator(
        ...
        return singletonList(
            new EmailNotificationGenerator(newArrayList(personalisation), notificationSender,
                notificationIdAppender)
        );
    }
    ...
    public List<NotificationGenerator> caseLinkAppealNotificationGenerator(
        ...
        return singletonList(
            new EmailNotificationGenerator(
                newArrayList(legalRepresentativeCaseLinkAppealPersonalisation,
                    homeOfficeCaseLinkPersonalisation),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> caseUnlinkAppealNotificationGenerator(
        ...
        return singletonList(
            new EmailNotificationGenerator(
                newArrayList(legalRepresentativeCaseUnlinkAppealPersonalisation,
                    homeOfficeCaseUnlinkPersonalisation),
                notificationSender,
                notificationIdAppender
            )
        );
        ...
        return singletonList(
            new EmailNotificationGenerator(
                newArrayList(legalRepresentativeUnlinkAppealPersonalisation,
                    homeOfficeUnlinkAppealPersonalisation),
                notificationSender,
                notificationIdAppender
            )
        );
        ...
        return singletonList(
            new EmailNotificationGenerator(
                newArrayList(legalRepresentativeLinkAppealPersonalisation,
                    homeOfficeLinkAppealPersonalisation),
                notificationSender,
                notificationIdAppender
            )
        );
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(homeOfficeEndAppealPersonalisation,
                    legalRepresentativeEndAppealPersonalisation),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> listCaseNotificationGenerator(
        ...
        // RIA-3361 - listCase
        List<EmailNotificationPersonalisation> emailPersonalisations =
    ...
    public List<NotificationGenerator> listCaseAdaNotificationGenerator(
        ...
        List<EmailNotificationPersonalisation> personalisations = isHomeOfficeGovNotifyEnabled
            ...
            legalRepresentativeListCasePersonalisation, homeOfficeListCasePersonalisation)
            : newArrayList(legalRepresentativeListCaseAdaSendStandardDirectionPersonalisation);
    ...
    public List<NotificationGenerator> listCaseAipNotificationGenerator(
        ...
        List<EmailNotificationPersonalisation> emailPersonalisations = isHomeOfficeGovNotifyEnabled
            ? newArrayList(caseOfficerListCasePersonalisation,
            appellantListCasePersonalisationEmail, homeOfficeListCasePersonalisation)
            : newArrayList(caseOfficerListCasePersonalisation,
                appellantListCasePersonalisationEmail);
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(homeOfficeSubmitAppealPersonalisation,
                    appellantSubmitAppealPersonalisationEmail),
                notificationSender,
                notificationIdAppender
            ),
            new SmsNotificationGenerator(
    ...
    public List<NotificationGenerator> submitAppealHoNotificationGenerator(
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                isHomeOfficeGovNotifyEnabled ? newArrayList(homeOfficeSubmitAppealPersonalisation)
                    : emptyList(),
                notificationSender,
                notificationIdAppender
            )
    ...
    public List<NotificationGenerator> submitAppealOutOfTimeAipNotificationGenerator(
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(homeOfficeSubmitAppealPersonalisation,
                    appellantSubmitAppealOutOfTimePersonalisationEmail),
                notificationSender,
                notificationIdAppender
            ),
            new SmsNotificationGenerator(
    ...
    public List<NotificationGenerator> submitReasonsForAppealAipNotificationGenerator(
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(appellantSubmitReasonsForAppealPersonalisationEmail,
        ...
        return singletonList(
            new EmailNotificationGenerator(
                newArrayList(legalRepresentativeRequestHearingRequirementsPersonalisation,
                    caseOfficerRequestHearingRequirementsPersonalisation),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> respondentReviewAipNotificationGenerator(
        ...
        List<EmailNotificationPersonalisation> personalisations = isHomeOfficeGovNotifyEnabled
            ? newArrayList(respondentDirectionPersonalisation,
            appellantRespondentReviewPersonalisationEmail)
    ...
    public List<NotificationGenerator> recordApplicationNotificationGenerator(
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(homeOfficeRecordApplicationPersonalisation,
                    legalRepresentativeRecordApplicationPersonalisation),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> editCaseListingRepNotificationGenerator(
        ...
        List<EmailNotificationPersonalisation> personalisations = isHomeOfficeGovNotifyEnabled
            ? newArrayList(homeOfficeEditListingPersonalisation,
            legalRepresentativeEditListingPersonalisation,
            legalRepresentativeEditListingNoChangePersonalisation,
            homeOfficeEditListingNoChangePersonalisation, caseOfficerEditListingPersonalisation,
            appellantEditListingPersonalisationEmail)
            : newArrayList(legalRepresentativeEditListingPersonalisation,
                legalRepresentativeEditListingNoChangePersonalisation,
                caseOfficerEditListingPersonalisation, appellantEditListingPersonalisationEmail);
    ...
    public List<NotificationGenerator> editCaseListingAipNotificationGenerator(
        ...
        List<EmailNotificationPersonalisation> personalisations = isHomeOfficeGovNotifyEnabled
            ? newArrayList(homeOfficeEditListingPersonalisation,
            appellantEditListingPersonalisationEmail, homeOfficeEditListingNoChangePersonalisation,
            caseOfficerEditListingPersonalisation)
            : newArrayList(appellantEditListingPersonalisationEmail,
                caseOfficerEditListingPersonalisation);
    ...
    public List<NotificationGenerator> uploadHomeOfficeAppealResponseInternalAdaNotificationGenerator(
        ...
        return Arrays.asList(
            new EmailWithLinkNotificationGenerator(
                newArrayList(Collections.singleton(
    ...
    public List<NotificationGenerator> hearingBundleReadyRepNotificationGenerator(
        ...
        List<EmailNotificationPersonalisation> personalisations = isHomeOfficeGovNotifyEnabled
            ...
            legalRepresentativeHearingBundleReadyPersonalisation)
    ...
    public List<NotificationGenerator> submittedHearingRequirementsNotificationGenerator(
        ...
        return singletonList(
            new EmailNotificationGenerator(
                newArrayList(legalRepresentativeSubmittedHearingRequirementsPersonalisation,
    ...
    public List<NotificationGenerator> reviewedAdaHearingRequirementsNotificationGenerator(
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(legalRepresentativeAdaReviewHearingRequirementsPersonalisation,
                    homeOfficeAdaReviewHearingRequirementsPersonalisation),
                notificationSender,
                notificationIdAppender
            )
        );
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(homeOfficeUploadAdditionalEvidencePersonalisation,
                    caseOfficerUploadAdditionalEvidencePersonalisation),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> uploadAdditionalEvidenceHomeOffice(
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(legalRepresentativeUploadAdditionalEvidencePersonalisation,
                    caseOfficerUploadAdditionalEvidencePersonalisation),
                notificationSender,
                notificationIdAppender
            )
    ...
    public List<NotificationGenerator> uploadAddendumEvidenceCaseOfficer(
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(homeOfficeUploadAddendumEvidencePersonalisation,
    ...
    public List<NotificationGenerator> uploadAddendumEvidenceHomeOffice(
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(legalRepresentativeUploadAddendumEvidencePersonalisation,
    ...
    public List<NotificationGenerator> uploadAddendumEvidenceHomeOfficeAip(
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(appellantHomeOfficeOrUploadAddendumEvidencePersonalisationEmail,
                    caseOfficerUploadAddendumEvidencePersonalisation),
                notificationSender,
                notificationIdAppender
            ),
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(homeOfficeAppealExitedOnlinePersonalisation,
                    legalRepresentativeAppealExitedOnlinePersonalisation),
                notificationSender,
                notificationIdAppender)
        );
    }
    ...
    public List<NotificationGenerator> ftpaSubmittedRespondent(
        ...
        List<EmailNotificationPersonalisation> personalisations = isHomeOfficeGovNotifyEnabled
            ...
            : newArrayList(adminOfficerFtpaSubmittedPersonalisation,
                legalRepresentativeRespondentFtpaSubmittedPersonalisation);
    ...
    public List<NotificationGenerator> ftpaSubmittedRespondentAipJourney(
        ...
        List<EmailNotificationPersonalisation> personalisations = isHomeOfficeGovNotifyEnabled
            ? newArrayList(respondentFtpaSubmittedPersonalisation,
            adminOfficerFtpaSubmittedPersonalisation,
            appellantRespondentFtpaSubmittedPersonalisationEmail)
            : newArrayList(adminOfficerFtpaSubmittedPersonalisation,
                appellantRespondentFtpaSubmittedPersonalisationEmail);
    ...
    public List<NotificationGenerator> submitClarifyingQuestionAnswersNotificationGenerator(
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(appellantSubmitClarifyingQuestionAnswersPersonalisationEmail,
    ...
    public List<NotificationGenerator> forceAppellantCaseToCaseUnderReviewEmailNotificationGenerator(
        ...
        return List.of(
            new EmailNotificationGenerator(
                newArrayList(homeOfficePersonalisation,
                    appellantForceCaseProgressionToCaseUnderReviewPersonalisationEmail),
                notificationSender,
                notificationIdAppender)
        );
    }
    ...
    public List<NotificationGenerator> adjournHearingWithoutDateNotificationNonIntegratedGenerator(
        ...
        List<EmailNotificationPersonalisation> personalisations = isHomeOfficeGovNotifyEnabled
            ? newArrayList(legalRepresentativeAdjournHearingWithoutDatePersonalisation,
    ...
    public List<NotificationGenerator> internalAdjournHearingWithoutDateNotificationGenerator(
        ...
        return List.of(
            new EmailWithLinkNotificationGenerator(
                newArrayList(Collections.singleton(
                    detentionEngagementTeamHearingAdjournedWithoutDatePersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> recordAdjournmentDetailsNonIntegratedNotificationGenerator(
        ...
        List<EmailNotificationPersonalisation> personalisations = isHomeOfficeGovNotifyEnabled
            ? newArrayList(legalRepresentativeRecordAdjournmentDetailsPersonalisation,
            respondentRecordAdjournmentDetailsPersonalisation,
    ...
    public List<NotificationGenerator> submitCmaRequirementsAipNotificationGenerator(
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(appellantSubmitCmaRequirementsPersonalisationEmail,
    ...
    public List<NotificationGenerator> hoInternalNonStandardDirectionGenerator(
        ...
        return Arrays.asList(
            new EmailWithLinkNotificationGenerator(
                newArrayList(
                    detentionEngagementTeamInternalNonStandardDirectionToRespondentPersonalisation),
                notificationSender,
                notificationIdAppender
            ),
            new EmailNotificationGenerator(
    ...
    public List<NotificationGenerator> requestResponseAmendDirectionGenerator(
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                isHomeOfficeGovNotifyEnabled ? newArrayList(
    ...
    public List<NotificationGenerator> listCmaAipNotificationGenerator(
        ...
        return Arrays.asList(
            new EmailNotificationGenerator(
                newArrayList(appellantListCmaPersonalisationEmail, homeOfficeListCmaPersonalisation,
                    caseOfficerListCmaPersonalisation),
                notificationSender,
                notificationIdAppender
            ),
            new SmsNotificationGenerator(
    ...
    public List<NotificationGenerator> editAppealAfterSubmitInternalCaseNotificationGenerator(
        ...
        return Arrays.asList(
            ...
            new EmailWithLinkNotificationGenerator(
                newArrayList(
                    Collections.singleton(detentionEngagementTeamEditAppealPersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> ftpaApplicationDecisionRefusedOrNotAdmittedAppellantAipJourneyNotificationGenerator(
        ...
        List<EmailNotificationPersonalisation> emailPersonalisations = isHomeOfficeGovNotifyEnabled
            ? newArrayList(homeOfficeFtpaApplicationDecisionAppellantPersonalisation,
            appellantFtpaApplicationDecisionPersonalisationEmail)
    ...
    public List<NotificationGenerator> ftpaApplicationDecisionGrantedOrPartiallyAppellantGrantedNotificationGenerator(
        ...
        List<EmailNotificationPersonalisation> personalisations = isHomeOfficeGovNotifyEnabled
            ? newArrayList(homeOfficeFtpaApplicationDecisionAppellantPersonalisation,
            legalRepresentativeFtpaApplicationDecisionAppellantPersonalisation,
            adminOfficerFtpaDecisionAppellantPersonalisation)
            : newArrayList(legalRepresentativeFtpaApplicationDecisionAppellantPersonalisation,
                adminOfficerFtpaDecisionAppellantPersonalisation);
    ...
    public List<NotificationGenerator> ftpaApplicationDecisionGrantedOrPartiallyRespondentGrantedNotificationGenerator(
        ...
        List<EmailNotificationPersonalisation> personalisations = isHomeOfficeGovNotifyEnabled
            ? newArrayList(homeOfficeFtpaApplicationDecisionRespondentPersonalisation,
            legalRepresentativeFtpaApplicationDecisionRespondentPersonalisation,
            adminOfficerFtpaDecisionRespondentPersonalisation)
            : newArrayList(legalRepresentativeFtpaApplicationDecisionRespondentPersonalisation,
                adminOfficerFtpaDecisionRespondentPersonalisation);
    ...
    public List<NotificationGenerator> ftpaApplicationInternalDecisionGrantedOrPartiallyRespondentGrantedNotificationGenerator(
        ...
        List<EmailNotificationPersonalisation> personalisations = newArrayList(
            adminOfficerFtpaDecisionRespondentPersonalisation);
    ...
    public List<NotificationGenerator> ftpaApplicationDecisionReheardAppellantNotificationGenerator(
        ...
        List<EmailNotificationPersonalisation> personalisations = isHomeOfficeGovNotifyEnabled
            ? newArrayList(homeOfficeFtpaApplicationDecisionAppellantPersonalisation,
            legalRepresentativeFtpaApplicationDecisionAppellantPersonalisation,
            caseOfficerFtpaDecisionPersonalisation)
            : newArrayList(legalRepresentativeFtpaApplicationDecisionAppellantPersonalisation,
                caseOfficerFtpaDecisionPersonalisation);
    ...
    public List<NotificationGenerator> recordOfTimeDecisionCanProceedEmailInternalNotificationHandler(
        ...
        return Arrays.asList(
            new EmailWithLinkNotificationGenerator(
                newArrayList(Collections.singleton(
                    detentionEngagementTeamRecordOutOfTimeDecisionCanProceedPersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> internalDetAppealDecidedNotificationGenerator(
        ...
        return Arrays.asList(
            new EmailWithLinkNotificationGenerator(
                newArrayList(
                    Collections.singleton(detentionEngagementTeamAppealDecidedPersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> internalSubmitAppealInTimeNotificationGenerator(
        ...
        return Arrays.asList(
            new EmailWithLinkNotificationGenerator(
                newArrayList(Collections.singleton(
                    detentionEngagementTeamAppealSubmittedInTimePersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> internalEndAppealAutomaticallyNotificationGenerator(
        ...
        return Arrays.asList(
            new EmailWithLinkNotificationGenerator(
                newArrayList(Collections.singleton(
                    detentionEngagementTeamEndAppealAutomaticallyPersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> internalDetainedAppealFeeDueNotificationGenerator(
        ...
        return Arrays.asList(
            new EmailWithLinkNotificationGenerator(
                newArrayList(
                    Collections.singleton(detentionEngagementTeamAppealFeeDuePersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> markAsPaidInternalDetandHoNotificationHandler(
        ...
        HomeOfficeSubmitAppealPersonalisation homeOfficeSubmitAppealPersonalisation,
        //identical notification already existing for different event, reusing it.
        GovNotifyNotificationSender notificationSender,
        NotificationIdAppender notificationIdAppender) {
    ...
    public List<NotificationGenerator> requestHearingRequirementsInternalDetainedNotificationGenerator(
        ...
        return List.of(
            new EmailWithLinkNotificationGenerator(
                newArrayList(Collections.singleton(
                    detentionEngagementTeamRequestHearingRequirementPersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> endAppealInternalDetainedNotificationGenerator(
        ...
        return List.of(
            new EmailWithLinkNotificationGenerator(
                newArrayList(
                    Collections.singleton(detentionEngagementTeamEndAppealPersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> internalMarkAppealAsAdaNotificationGenerator(
        ...
        return List.of(
            new EmailWithLinkNotificationGenerator(
                newArrayList(
                    Collections.singleton(detentionEngagementTeamMarkAppealAsAdaPersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> editCaseListingInternalDetainedNotificationGenerator(
        ...
        return List.of(
            new EmailWithLinkNotificationGenerator(
                newArrayList(
                    Collections.singleton(detentionEngagementTeamEditCaseListingPersonalisation)),
                notificationSender,
                notificationIdAppender
            ),
            new EmailNotificationGenerator(
    ...
    public List<NotificationGenerator> internalDetainedManageFeeUpdateNotificationGenerator(
        ...
        return List.of(
            new EmailWithLinkNotificationGenerator(
                newArrayList(
                    Collections.singleton(detentionEngagementTeamManageFeeUpdatePersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> internalDetainedTransferOutOfAdaNotificationGenerator(
        ...
        return List.of(
            new EmailWithLinkNotificationGenerator(
                newArrayList(
                    Collections.singleton(detentionEngagementTeamTransferOutOfAdaPersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> internalUploadAdditionalEvidenceNotificationGenerator(
        ...
        return List.of(
            new EmailWithLinkNotificationGenerator(
                newArrayList(Collections.singleton(
                    detentionEngagementTeamUploadAdditionalEvidencePersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> internalRequestResponseAmendNotificationGenerator(
        ...
        return List.of(
            new EmailWithLinkNotificationGenerator(
                newArrayList(Collections.singleton(
                    detentionEngagementTeamRequestResponseAmendPersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> internalDetainedAppellantOnlyChangeDirectionDueDateNotificationGenerator(
        ...
        return List.of(
            new EmailWithLinkNotificationGenerator(
                newArrayList(
                    Collections.singleton(detentionEngagementTeamChangeDueDatePersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> internalDetainedAppellantHoChangeDirectionDueDateNotificationGenerator(
        ...
        return List.of(
            new EmailWithLinkNotificationGenerator(
                newArrayList(Collections.singleton(
                    detentionEngagementTeamChangeHoDirectionDueDatePersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> internalHomeOfficeUploadAdditionalAddendumEvidenceNotificationGenerator(
        ...
        return List.of(
            new EmailWithLinkNotificationGenerator(
                newArrayList(Collections.singleton(
                    detentionEngagementTeamHomeOfficeUploadAdditionalAddendumEvidencePersonalisation)),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> applyForCostsNotificationGenerator(
        ...
        return singletonList(new EmailNotificationGenerator(
            newArrayList(applyForCostsRespondentPersonalisation,
                applyForCostsApplicantPersonalisation),
            notificationSender,
            notificationIdAppender)
        );
    }
    ...
    public List<NotificationGenerator> respondToCostsNotificationGenerator(
        ...
        return singletonList(new EmailNotificationGenerator(
                newArrayList(respondToCostsApplicantPersonalisation,
                    respondToCostsRespondentPersonalisation),
                notificationSender,
                notificationIdAppender
            )
        );
    ...
    public List<NotificationGenerator> considerMakingCostOrderNotificationGenerator(
        ...
        return singletonList(new EmailNotificationGenerator(
            newArrayList(considerMakingCostOrderLegalRepPersonalisation,
                considerMakingCostOrderHoPersonalisation),
            notificationSender,
            notificationIdAppender)
        );
    }
