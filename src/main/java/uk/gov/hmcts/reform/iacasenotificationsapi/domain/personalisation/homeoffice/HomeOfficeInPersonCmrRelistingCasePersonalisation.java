...
@Service
public class HomeOfficeInPersonCmrRelistingCasePersonalisation implements EmailNotificationPersonalisation {

    private final String listAssistHearingHomeOfficeCaseRelistedTemplateId;
    ...
    public HomeOfficeInPersonCmrRelistingCasePersonalisation(
        ...
        this.listAssistHearingHomeOfficeCaseRelistedTemplateId = listAssistHearingHomeOfficeCaseRelistedTemplateId;
    ...
    public String getTemplateId(AsylumCase asylumCase) {
        return listAssistHearingHomeOfficeCaseRelistedTemplateId;
    }
