...
public class DetentionEngagementTeamCmrReListingManualAipDetainedPersonalisation implements EmailWithLinkNotificationPersonalisation {
    ...
    public String getReferenceId(Long caseId) {
        return caseId + "_INTERNAL_CMR_RE_LISTING_LETTER_DET";
    }
    ...
    private JSONObject getInternalEditAppealDocumentInJsonObject(AsylumCase asylumCase) {
        try {
            ...
            log.error("Failed to get Internal Detained CMR relisting document in compatible format", e);
            throw new IllegalStateException("Failed to get Internal Detained CMR relisting letter document in compatible format");
        }
    }
}
