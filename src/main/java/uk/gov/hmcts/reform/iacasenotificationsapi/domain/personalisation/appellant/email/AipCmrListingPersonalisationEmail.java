...
@Service
public class AipCmrListingPersonalisationEmail implements EmailNotificationPersonalisation {

    private final String aipCmrListingAppellantEmailTemplateId;
    private final String aipCmrListingRemoteAppellantEmailTemplateId;
    ...
    public String getTemplateId(AsylumCase asylumCase) {
        if (asylumCase.read(IS_REMOTE_HEARING, YesOrNo.class).orElse(YesOrNo.NO) == YesOrNo.YES) {
            ...
            return aipCmrListingAppellantEmailTemplateId;
