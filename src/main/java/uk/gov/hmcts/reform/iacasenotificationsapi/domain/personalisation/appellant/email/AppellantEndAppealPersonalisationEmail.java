    ...
    public Map<String, String> getPersonalisation(AsylumCase asylumCase) {
        ...
        return
                ImmutableMap
                        ...
                        .put("legalRepReferenceNumber", asylumCase.read(JOURNEY_TYPE, JourneyType.class)
                                .filter(j -> j == JourneyType.AIP)
                                .map(j -> "N/A")
                                .orElse(asylumCase.read(LEGAL_REP_REFERENCE_NUMBER, String.class).orElse("")))
