...
@Slf4j
@Service
public class DetentionEngagementTeamInternalAdaSuitabilityReviewPersonalisation implements EmailWithLinkNotificationPersonalisation {

    private final String internalAdaSuitabilityReviewTemplateId;
    private final DocumentDownloadClient documentDownloadClient;
    private final DetEmailService detEmailService;

    public DetentionEngagementTeamInternalAdaSuitabilityReviewPersonalisation(
        @Value("${govnotify.template.adaSuitabilityReview.detentionEngagementTeam.internalAda.email}") String internalAdaSuitabilityReviewTemplateId,
