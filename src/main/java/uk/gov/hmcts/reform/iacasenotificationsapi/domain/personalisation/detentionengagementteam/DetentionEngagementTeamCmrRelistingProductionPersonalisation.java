...
@Slf4j
@Service
public class DetentionEngagementTeamCmrRelistingProductionPersonalisation implements EmailNotificationPersonalisation {

    private final String caseRelistedProductionDetainedTemplateId;
    ...
    public DetentionEngagementTeamCmrRelistingProductionPersonalisation(
        ...
        this.caseRelistedProductionDetainedTemplateId = caseRelistedProductionDetainedTemplateId;
    ...
    public String getTemplateId() {
        return caseRelistedProductionDetainedTemplateId;
    }
    ...
    public String getReferenceId(Long caseId) {
        return caseId + "_DETAINED_CMR_RE_LISTING_PRODUCTION_DET";
    }
