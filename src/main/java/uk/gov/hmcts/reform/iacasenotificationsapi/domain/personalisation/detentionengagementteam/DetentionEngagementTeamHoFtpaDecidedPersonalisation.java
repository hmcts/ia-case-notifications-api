...
@Slf4j
@Service
public class DetentionEngagementTeamHoFtpaDecidedPersonalisation implements EmailWithLinkNotificationPersonalisation {
    ...
    public DetentionEngagementTeamHoFtpaDecidedPersonalisation(
