...
@Service
public class LegalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisation implements LetterNotificationPersonalisation {
    private final String legalRepInternalCaseSubmitAppealWithFeeOutOfTimeLetterTemplateId;
    private final CustomerServicesProvider customerServicesProvider;
    private final SystemDateProvider systemDateProvider;
    private final int daysAfterSubmitAppeal;

    public LegalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisation(
        @Value("${govnotify.template.appealSubmitted.appellant.letter.outOfTime.withFee}") String legalRepInternalCaseSubmitAppealWithFeeOutOfTimeLetterTemplateId,
        @Value("${appellantDaysToWait.letter.afterSubmitAppealWithFee}") int daysAfterSubmitAppeal,
        CustomerServicesProvider customerServicesProvider,
        SystemDateProvider systemDateProvider
    ) {
        this.legalRepInternalCaseSubmitAppealWithFeeOutOfTimeLetterTemplateId = legalRepInternalCaseSubmitAppealWithFeeOutOfTimeLetterTemplateId;
    ...
    public String getTemplateId() {
        return legalRepInternalCaseSubmitAppealWithFeeOutOfTimeLetterTemplateId;
    }
    ...
    public String getReferenceId(Long caseId) {
        return caseId + "_INTERNAL_SUBMIT_APPEAL_WITH_FEE_OUT_OF_TIME_LEGAL_REP_LETTER";
    }
