...
public class NotificationHandlerConfiguration {
    ...
    @Bean
    public PreSubmitCallbackHandler<AsylumCase> submitAppealPaymentPendingLegalRepNotificationHandler(
        @Qualifier("submitAppealPaymentPendingNotificationGenerator") List<NotificationGenerator> notificationGenerators) {
    ...
    public PreSubmitCallbackHandler<AsylumCase> paymentPendingPaidLegalRepNotificationHandler(
        ...
        return new NotificationHandler(
            (callbackStage, callback) -> {
                ...
                boolean isCorrectAppealTypeHUorEA = asylumCase
                    .read(APPEAL_TYPE, AppealType.class)
                ...
                boolean isCorrectAppealTypeAndStateHUorEA =
                    isCorrectAppealTypeHUorEA
                    && (currentState == State.PENDING_PAYMENT);

                boolean isCorrectAppealTypeAndStatePA =
                ...
                return callbackStage == PreSubmitCallbackStage.ABOUT_TO_SUBMIT
                       ...
                       && (isCorrectAppealTypeAndStateHUorEA || isCorrectAppealTypeAndStatePA)
                       && paymentStatus.equals("Success");
            }, notificationGenerators
        );
    }
