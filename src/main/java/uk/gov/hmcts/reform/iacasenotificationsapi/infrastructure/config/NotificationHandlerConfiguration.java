...
public class NotificationHandlerConfiguration {
    ...
    @Bean
    public PreSubmitCallbackHandler<AsylumCase> aipRemoveDetentionStatusAppellantNotificationHandler(
            @Qualifier("aipRemoveDetentionStatusNotificationGenerator")
            List<NotificationGenerator> notificationGenerators) {
