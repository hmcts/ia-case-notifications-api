...
@Service
@Slf4j
public class AppellantHearingReqReviewStatutoryTimeframe24WeeksPersonalisationLetter implements LetterNotificationPersonalisation {
    ...
    public AppellantHearingReqReviewStatutoryTimeframe24WeeksPersonalisationLetter(
            @Value(STF_24_WEEKS_HEARING_REQUIREMENTS_LETTER_TEMPLATE) String removeStatutoryTimeframe24WeeksAppellantLetterId,
