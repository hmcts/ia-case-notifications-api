...
public class HomeOfficeEndAppealPersonalisation implements EmailNotificationPersonalisation {
    ...
    private final String apcAppealEmailAddresses;
    ...
    public HomeOfficeEndAppealPersonalisation(
        ...
        @Value("${apcHomeOfficeEmailAddress}") String apcAppealEmailAddresses,
        ...
        this.apcAppealEmailAddresses = apcAppealEmailAddresses;
    ...
    public Set<String> getRecipientsList(AsylumCase asylumCase) {
        ...
        return outcome.equals(WITHDRAWN)
            ...
            : Collections.singleton(apcAppealEmailAddresses);
    }
