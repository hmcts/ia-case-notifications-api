...
public enum DocumentTag {
    ...
    INTERNAL_CMR_LISTING_LETTER("internalCmrListingLetter"),
    ...
    REMOTE_CMR_LISTING_LETTER("remoteCmrListingLetter"),
    REMOTE_CMR_LISTING_LETTER_BUNDLE("remoteCmrListingLetterBundle"),
    REMOTE_CMR_LISTING_LR_LETTER("remoteCmrListingLrLetter"),
    REMOTE_CMR_LISTING_LR_LETTER_BUNDLE("remoteCmrListingLrLetterBundle"),
    REMOTE_CMR_RE_LISTING_LETTER("remoteCmrReListingLetter"),
    REMOTE_CMR_RE_LISTING_LETTER_BUNDLE("remoteCmrReListingLetterBundle"),
    REMOTE_CMR_RE_LISTING_LR_LETTER("remoteCmrReListingLrLetter"),
    REMOTE_CMR_RE_LISTING_LR_LETTER_BUNDLE("remoteCmrReListingLrLetterBundle"),
