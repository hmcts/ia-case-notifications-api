...
@Service
public class LegalRepCmrListingPersonalisation implements LegalRepresentativeEmailNotificationPersonalisation {

    private final String legalRepresentativeCmrListingTemplateId;
    ...
    public LegalRepCmrListingPersonalisation(
            @Value("${govnotify.template.listAssistHearing.caseListed.legalRep.email}") String legalRepresentativeCmrListingTemplateId,
        ...
        this.legalRepresentativeCmrListingTemplateId = legalRepresentativeCmrListingTemplateId;
    ...
    public String getReferenceId(Long caseId) {
        return caseId + "_CMR_LISTED_OR_REMOTE_LEGAL_REPRESENTATIVE_EMAIL";
    }
