...
public class AppellantCmrListingPersonalisationEmail implements EmailNotificationPersonalisation {
    ...
    private final String appellantCmrListingTemplateId;
    private final String legallyReppedAppellantCmrListingTemplateId;
    ...
    public AppellantCmrListingPersonalisationEmail(
        @Value("${govnotify.template.listAssistHearing.caseListed.appellant.email}") String appellantCmrListingTemplateId,
        @Value("${govnotify.template.listAssistHearing.caseListed.legallyReppedAppellant.email}") String legallyReppedAppellantCmrListingTemplateId,
        ...
        this.appellantCmrListingTemplateId = appellantCmrListingTemplateId;
        this.legallyReppedAppellantCmrListingTemplateId = legallyReppedAppellantCmrListingTemplateId;
    ...
    public String getTemplateId(AsylumCase asylumCase) {
        return isAipJourney(asylumCase) ? appellantCmrListingTemplateId : legallyReppedAppellantCmrListingTemplateId;
    }
