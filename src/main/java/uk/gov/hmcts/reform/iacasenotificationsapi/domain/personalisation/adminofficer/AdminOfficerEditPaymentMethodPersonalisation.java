...
public class AdminOfficerEditPaymentMethodPersonalisation implements EmailNotificationPersonalisation {
    ...
    private final String adminOfficerEditPaymentMethodPendingPaymentTemplateId;
    ...
    public AdminOfficerEditPaymentMethodPersonalisation(
        ...
        @Value("${govnotify.template.appealSubmitted.adminOfficer.editPaymentMethod.email}") String adminOfficerEditPaymentMethodPendingPaymentTemplateId,
        @Value("${feesAdminOfficerEmailAddress}") String feesAdminOfficerEmailAddress,
        AdminOfficerPersonalisationProvider adminOfficerPersonalisationProvider
    ) {
        this.adminOfficerEditPaymentMethodPendingPaymentTemplateId = adminOfficerEditPaymentMethodPendingPaymentTemplateId;
    ...
    public String getTemplateId() {
        return adminOfficerEditPaymentMethodPendingPaymentTemplateId;
    }
