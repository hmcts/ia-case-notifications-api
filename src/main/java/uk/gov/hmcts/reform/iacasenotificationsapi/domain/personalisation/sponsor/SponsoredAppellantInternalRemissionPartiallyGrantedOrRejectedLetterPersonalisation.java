...
@Service
public class SponsoredAppellantInternalRemissionPartiallyGrantedOrRejectedLetterPersonalisation implements LetterNotificationPersonalisation {
    private final String sponsoredAppellantInternalRemissionDecisionLetterTemplateId;
    ...
    public SponsoredAppellantInternalRemissionPartiallyGrantedOrRejectedLetterPersonalisation(
        ...
        this.sponsoredAppellantInternalRemissionDecisionLetterTemplateId = sponsoredAppellantInternalRemissionDecisionLetterTemplateId;
    ...
    public String getTemplateId() {
        return sponsoredAppellantInternalRemissionDecisionLetterTemplateId;
    }
