...
@Slf4j
@Service
public class DetentionEngagementTeamAdjournHearingWithoutDateProductionPersonalisation implements EmailNotificationPersonalisation {
    ...
    public DetentionEngagementTeamAdjournHearingWithoutDateProductionPersonalisation(
        @Value("${govnotify.template.adjournHearingWithoutDate.detentionEngagementTeam.production.email}") String caseListedProductionDetainedTemplateId,
    ...
    public String getReferenceId(Long caseId) {
        return caseId + "_DETAINED_CASE_ADJOURNED_HEARING_WITHOUT_DATE_PRODUCTION_DET";
    }
