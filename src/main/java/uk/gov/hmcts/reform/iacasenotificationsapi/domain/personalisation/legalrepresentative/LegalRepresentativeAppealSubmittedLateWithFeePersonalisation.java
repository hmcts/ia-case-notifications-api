...
@Slf4j
@Service
public class LegalRepresentativeAppealSubmittedLateWithFeePersonalisation implements LetterNotificationPersonalisation {
    ...
    public LegalRepresentativeAppealSubmittedLateWithFeePersonalisation(
    ...
    public String getReferenceId(Long caseId) {
        return caseId + "_LEGAL_REP_MANUAL_APPEAL_SUBMITTED_OUT_OF_TIME_WITH_FEE_LETTER";
    }
