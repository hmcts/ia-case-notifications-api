...
@Slf4j
@Service
public class DetentionEngagementTeamRecordAdjournmentDetailsProductionPersonalisation implements EmailNotificationPersonalisation {
    ...
    public DetentionEngagementTeamRecordAdjournmentDetailsProductionPersonalisation(
        @Value("${govnotify.template.recordAdjournmentDetails.detentionEngagementTeam.production.email}") String caseListedProductionDetainedTemplateId,
