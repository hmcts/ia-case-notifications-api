...
@Slf4j
@Service
public class AppellantCompleteCaseReview24WeeksLetterPersonalisation implements LetterNotificationPersonalisation {
    ...
    public AppellantCompleteCaseReview24WeeksLetterPersonalisation(
    ...
    public String getReferenceId(Long caseId) {
        return caseId + "_STATUTORY_TIMEFRAME_24WEEKS_CASE_REVIEW_APPELLANT_LETTER";
    }
