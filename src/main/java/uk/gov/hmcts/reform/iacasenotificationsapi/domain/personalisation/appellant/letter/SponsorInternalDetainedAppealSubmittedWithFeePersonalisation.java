...
@Service
public class SponsorInternalDetainedAppealSubmittedWithFeePersonalisation implements LetterNotificationPersonalisation {
    ...
    public SponsorInternalDetainedAppealSubmittedWithFeePersonalisation(
        @Value("${govnotify.template.appealSubmitted.sponsor.letter.inTime.withFee}") String appellantInternalCaseSubmitAppealWithFeeOutOfTimeLetterTemplateId,
    ...
    public String getReferenceId(Long caseId) {
        return caseId + "_INTERNAL_SUBMIT_APPEAL_WITH_FEE_SPONSOR_LETTER";
    }
