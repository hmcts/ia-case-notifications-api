...
public class LegalRepHearingRequirementsStf24WeeksEmailPersonalisation implements LegalRepresentativeEmailNotificationPersonalisation {
    ...
    public Map<String, String> getPersonalisation(AsylumCase asylumCase) {
        return Stf24WeeksUtil.buildHearingRequirementsEmailParams(LEGAL_REPRESENTATIVE, asylumCase, nonAdaPrefix, iaExUiFrontendUrl, customerServicesProvider, dateTimeExtractor, hearingDetailsFinder);
    }
