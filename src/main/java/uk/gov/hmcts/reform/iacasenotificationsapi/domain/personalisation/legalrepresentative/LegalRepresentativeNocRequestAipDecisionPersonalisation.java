...
@Service
public class LegalRepresentativeNocRequestAipDecisionPersonalisation implements EmailNotificationPersonalisation {
    ...
    public LegalRepresentativeNocRequestAipDecisionPersonalisation(
