...
import static uk.gov.hmcts.reform.iacasenotificationsapi.domain.entities.DocumentTag.INTERNAL_CMR_RE_LISTING_LETTER_BUNDLE;
import static uk.gov.hmcts.reform.iacasenotificationsapi.domain.utils.AsylumCaseUtils.getLetterForNotification;
import static uk.gov.hmcts.reform.iacasenotificationsapi.domain.utils.AsylumCaseUtils.isAppellantInDetention;

@Slf4j
@Service
public class DetentionEngagementTeamCmrRelistingPersonalisation implements EmailWithLinkNotificationPersonalisation {

    private final String internalDetainedCmrRelistingTemplateId;
    ...
    public DetentionEngagementTeamCmrRelistingPersonalisation(
        ...
        this.internalDetainedCmrRelistingTemplateId = internalDetainedCmrRelistingTemplateId;
    ...
    public String getTemplateId() {
        return internalDetainedCmrRelistingTemplateId;
    }
    ...
    public String getReferenceId(Long caseId) {
        return caseId + "_INTERNAL_DETAINED_CMR_RE_LISTING_DET";
    }
    ...
    public Map<String, Object> getPersonalisationForLink(AsylumCase asylumCase) {
        ...
        return ImmutableMap
                ...
                .put("documentLink", getInternalDetainedCaseRelistedLetterInJsonObject(asylumCase))
                .build();
    }

    private JSONObject getInternalDetainedCaseRelistedLetterInJsonObject(AsylumCase asylumCase) {
        try {
