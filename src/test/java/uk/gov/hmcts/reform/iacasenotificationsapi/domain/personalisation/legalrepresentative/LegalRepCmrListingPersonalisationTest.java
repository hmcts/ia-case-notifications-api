...
class LegalRepCmrListingPersonalisationTest {
    ...
    private LegalRepCmrListingPersonalisation personalisation;
    ...
    void setup() {
        ...
        personalisation = new LegalRepCmrListingPersonalisation(
                templateId,
                remoteTemplateId,
                frontendUrl,
                dateTimeExtractor,
