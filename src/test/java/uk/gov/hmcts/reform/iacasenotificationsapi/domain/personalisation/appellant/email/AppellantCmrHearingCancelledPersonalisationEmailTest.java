...
class AppellantCmrHearingCancelledPersonalisationEmailTest {
    ...
    private final String appellantManualCmrCancelledEmailTemplateId = "appellantManualCmrCancelledEmailTemplateId";
    ...
    public void setup() {
        ...
        appellantCmrHearingCancelledPersonalisationEmail = new AppellantCmrHearingCancelledPersonalisationEmail(
                ...
                appellantManualCmrCancelledEmailTemplateId,
                recipientsFinder,
                dateTimeExtractor,
    ...
    void should_return_given_template_id_appellant() {
        ...
        assertEquals(appellantCmrCancelledEmailTemplateId, appellantCmrHearingCancelledPersonalisationEmail.getTemplateId(asylumCase));
    }
    ...
    void should_return_given_template_id_appellant_manual() {
        ...
        assertEquals(appellantManualCmrCancelledEmailTemplateId, appellantCmrHearingCancelledPersonalisationEmail.getTemplateId(asylumCase));
    }
