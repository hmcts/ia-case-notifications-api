...
class DecideCostsApplicantPersonalisationTest {
    @Mock
    ...
    private DecideCostsApplicantPersonalisation decideCostsApplicantPersonalisationCostsApplicantPersonalisation;

    @BeforeEach
    void setup() {
        decideCostsApplicantPersonalisationCostsApplicantPersonalisation = new DecideCostsApplicantPersonalisation(
            templateId,
        ...
        Map<String, String> decideCostsApplicantPersonalisationCostsApplicantTemplate = new HashMap<>();

        decideCostsApplicantPersonalisationCostsApplicantTemplate.put("appellantGivenNames", appellantGivenNames);
        decideCostsApplicantPersonalisationCostsApplicantTemplate.put("appellantFamilyName", appellantFamilyName);
        decideCostsApplicantPersonalisationCostsApplicantTemplate.put("appealReferenceNumber", appealReferenceNumber);
        decideCostsApplicantPersonalisationCostsApplicantTemplate.put("applicationId", newestApplicationCreatedNumber);
        decideCostsApplicantPersonalisationCostsApplicantTemplate.put("appliedCostsType", "Wasted");
        decideCostsApplicantPersonalisationCostsApplicantTemplate.put("ariaListingReference", ariaListingReference);

        when((customerServicesProvider.getCustomerServicesTelephone())).thenReturn(customerServicesTelephone);
        when((customerServicesProvider.getCustomerServicesEmail())).thenReturn(customerServicesEmail);
        when(personalisationProvider.getApplyForCostsPesonalisation(asylumCase)).thenReturn(decideCostsApplicantPersonalisationCostsApplicantTemplate);
    ...
    void should_return_given_template_id() {
        assertEquals(templateId, decideCostsApplicantPersonalisationCostsApplicantPersonalisation.getTemplateId(asylumCase));
    }

    @Test
    void should_return_given_reference_id() {
        assertEquals(caseId + "_RESPOND_TO_COSTS_APPLICANT_EMAIL",
            decideCostsApplicantPersonalisationCostsApplicantPersonalisation.getReferenceId(caseId));
    }
    ...
    void should_return_given_email_address(List<IdValue<ApplyForCosts>> applyForCostsList) {
        ...
        if (applyForCostsList.get(0).getValue().getApplyForCostsApplicantType().equals(homeOffice)) {
            assertTrue(decideCostsApplicantPersonalisationCostsApplicantPersonalisation.getRecipientsList(asylumCase).contains(homeOfficeEmailAddress));
        } else {
            assertTrue(decideCostsApplicantPersonalisationCostsApplicantPersonalisation.getRecipientsList(asylumCase).contains(legalRepEmailAddress));
        }
    }
    ...
    void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        assertThatThrownBy(() -> decideCostsApplicantPersonalisationCostsApplicantPersonalisation.getPersonalisation((AsylumCase) null))
    ...
    void should_return_personalisation_when_all_information_given(List<IdValue<ApplyForCosts>> applyForCostsList) {
        ...
        Map<String, String> personalisation = decideCostsApplicantPersonalisationCostsApplicantPersonalisation.getPersonalisation(asylumCase);
