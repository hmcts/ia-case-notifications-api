...
class LegalRepRemoveStatutoryTimeframe24WeeksLetterPersonalisationTest {
    ...
    private LegalRepRemoveStatutoryTimeframe24WeeksLetterPersonalisation personalisation;

    @BeforeEach
    void setUp() {
        personalisation = new LegalRepRemoveStatutoryTimeframe24WeeksLetterPersonalisation(
                TEMPLATE_ID,
