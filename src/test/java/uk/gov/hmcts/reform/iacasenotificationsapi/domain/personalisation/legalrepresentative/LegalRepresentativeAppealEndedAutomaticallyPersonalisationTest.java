...
public class LegalRepresentativeAppealEndedAutomaticallyPersonalisationTest {
    ...
    public void should_return_given_template_id() {
        assertEquals(templateId, legalRepresentativeAppealEndedAutomaticallyPersonalisation.getTemplateId());
    }

    @Test
    public void should_return_given_reference_id() {
        assertEquals(caseId + "_APPEAL_ENDED_AUTOMATICALLY_LEGAL_REPRESENTATIVE",
            legalRepresentativeAppealEndedAutomaticallyPersonalisation.getReferenceId(caseId));
    }

    @Test
    public void should_return_given_email_address_from_asylum_case() {
        assertTrue(legalRepresentativeAppealEndedAutomaticallyPersonalisation.getRecipientsList(asylumCase)
    ...
    public void should_throw_exception_when_cannot_find_email_address_for_legal_rep() {
        ...
        assertThatThrownBy(() -> legalRepresentativeAppealEndedAutomaticallyPersonalisation.getRecipientsList(asylumCase))
    ...
    public void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        assertThatThrownBy(
            () -> legalRepresentativeAppealEndedAutomaticallyPersonalisation.getPersonalisation((AsylumCase) null))
