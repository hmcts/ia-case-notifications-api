...
public class AppellantLegallyReppedCmrRelistingPersonalisationEmailTest {
    ...
    private AppellantLegallyReppedCmrRelistingPersonalisationEmail appellantLegallyReppedCmrRelistingPersonalisationEmail;

    @BeforeEach
    public void setUp() {
        appellantLegallyReppedCmrRelistingPersonalisationEmail = new AppellantLegallyReppedCmrRelistingPersonalisationEmail(
                inPersonTemplateId,
                remoteTemplateId,
                iaExUiFrontendUrl,
        ...
        org.springframework.test.util.ReflectionTestUtils.setField(appellantLegallyReppedCmrRelistingPersonalisationEmail, "adaPrefix", adaPrefix);
        org.springframework.test.util.ReflectionTestUtils.setField(appellantLegallyReppedCmrRelistingPersonalisationEmail, "nonAdaPrefix", nonAdaPrefix);
    }
    ...
    public void should_return_in_person_template_id_when_not_remote_hearing() {
        ...
        assertEquals(inPersonTemplateId, appellantLegallyReppedCmrRelistingPersonalisationEmail.getTemplateId(asylumCase));
    }
    ...
    public void should_return_remote_template_id_when_remote_hearing() {
        ...
        assertEquals(remoteTemplateId, appellantLegallyReppedCmrRelistingPersonalisationEmail.getTemplateId(asylumCase));
    }
    ...
    public void should_return_correct_reference_id() {
        assertEquals(caseId + "_CMR_LISTED_OR_REMOTE_APPELLANT_EMAIL",
                appellantLegallyReppedCmrRelistingPersonalisationEmail.getReferenceId(caseId));
    }
    ...
    public void should_return_recipients_for_aip_journey() {
        ...
        Set<String> recipients = appellantLegallyReppedCmrRelistingPersonalisationEmail.getRecipientsList(asylumCase);
    ...
    public void should_throw_exception_when_asylum_case_is_null_for_recipients() {
        assertThrows(NullPointerException.class,
                () -> appellantLegallyReppedCmrRelistingPersonalisationEmail.getRecipientsList(null));
    }
    ...
    public void should_return_personalisation_when_all_information_given() {
        ...
        Map<String, String> personalisation =
                appellantLegallyReppedCmrRelistingPersonalisationEmail.getPersonalisation(asylumCase);
    ...
    public void should_throw_exception_when_asylum_case_is_null_for_personalisation() {
        NullPointerException exception = assertThrows(NullPointerException.class,
                () -> appellantLegallyReppedCmrRelistingPersonalisationEmail.getPersonalisation((AsylumCase) null));
