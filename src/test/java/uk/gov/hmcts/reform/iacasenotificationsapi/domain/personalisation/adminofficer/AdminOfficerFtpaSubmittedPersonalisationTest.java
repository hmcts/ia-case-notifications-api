...
public class AdminOfficerFtpaSubmittedPersonalisationTest {
    ...
    public void setUp() {
        ...
        adminOfficerFtpaSubmittedPersonalisation = new AdminOfficerFtpaSubmittedPersonalisation(govNotifyTemplateIdConfiguration, personalisationProvider, adminOfficerEmailAddress);
    }
    ...
    public void should_return_given_template_id() {
        ...
        when(govNotifyTemplateIdConfiguration.getFtpaSubmittedAdminTemplateId()).thenReturn(templateId);
