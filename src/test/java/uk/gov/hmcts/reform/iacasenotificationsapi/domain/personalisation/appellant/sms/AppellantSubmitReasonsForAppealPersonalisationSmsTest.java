...
public class AppellantSubmitReasonsForAppealPersonalisationSmsTest {
    ...
    public void should_return_given_template_id() {
        assertEquals(smsTemplateId, appellantReasonsForAppealSubmittedPersonalisationSms.getTemplateId());
    }

    @Test
    public void should_return_given_reference_id() {
        Long caseId = 12345L;
        assertEquals(caseId + "_SUBMIT_REASONS_FOR_APPEAL_APPELLANT_AIP_SMS", appellantReasonsForAppealSubmittedPersonalisationSms.getReferenceId(caseId));
    }
...
assertThrows(NullPointerException.class, () -> appellantReasonsForAppealSubmittedPersonalisationSms.getRecipientsList(null))
            ;
