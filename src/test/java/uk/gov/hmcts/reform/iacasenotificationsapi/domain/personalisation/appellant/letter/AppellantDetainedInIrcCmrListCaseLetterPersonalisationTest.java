...
public class AppellantDetainedInIrcCmrListCaseLetterPersonalisationTest {
    ...
    private AppellantDetainedInIrcCmrListCaseLetterPersonalisation appellantDetainedInIrcCmrListCaseLetterPersonalisation;
    ...
    public void should_return_given_reference_id() {
        ...
        assertEquals(caseId + "_CASE_LISTED_AIP_APPELLANT_EMAIL",
            appellantDetainedInIrcCmrListCaseLetterPersonalisation.getReferenceId(caseId));
    }
    ...
    public void should_return_given_email_address_list_from_subscribers_in_asylum_case() {
        ...
        assertTrue(appellantDetainedInIrcCmrListCaseLetterPersonalisation.getRecipientsList(asylumCase)
    ...
    public void should_throw_exception_on_recipients_when_case_is_null() {
        NullPointerException exception =
            assertThrows(NullPointerException.class, () -> appellantDetainedInIrcCmrListCaseLetterPersonalisation.getRecipientsList(null));
    ...
    public void should_throw_exception_on_personalisation_when_case_is_null() {
        NullPointerException exception =
            assertThrows(NullPointerException.class, () -> appellantDetainedInIrcCmrListCaseLetterPersonalisation.getPersonalisation((AsylumCase) null));
        assertEquals("asylumCase must not be null", exception.getMessage());
    }
    ...
    void should_throw_personalisation_when_no_hearing_centre() {
        ...
        IllegalArgumentException exception =
            assertThrows(IllegalArgumentException.class,
                () -> appellantDetainedInIrcCmrListCaseLetterPersonalisation.getPersonalisation(asylumCase));
    ...
    void should_return_personalisation_when_all_information_given(YesOrNo isAda) {
        ...
        initializePrefixes(appellantDetainedInIrcCmrListCaseLetterPersonalisation);
        when(asylumCase.read(IS_ACCELERATED_DETAINED_APPEAL, YesOrNo.class)).thenReturn(Optional.of(isAda));

        Map<String, String> personalisation = appellantDetainedInIrcCmrListCaseLetterPersonalisation.getPersonalisation(asylumCase);
