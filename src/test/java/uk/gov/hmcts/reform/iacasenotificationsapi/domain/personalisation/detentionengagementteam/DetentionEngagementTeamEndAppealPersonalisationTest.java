...
class DetentionEngagementTeamEndAppealPersonalisationTest {
    ...
    final DocumentWithMetadata endAppealDoc = TestUtils.getDocumentWithMetadata(
        "id", "internal_end_appeal", "some other desc", DocumentTag.END_APPEAL);
    final IdValue<DocumentWithMetadata> endAppealBundle = new IdValue<>("1", endAppealDoc);
    ...
    void should_throw_exception_when_no_detention_facility() {
        ...
        IllegalStateException exception =
            assertThrows(IllegalStateException.class, () -> detentionEngagementTeamEndAppealPersonalisation.getRecipientsList(asylumCase));
    ...
    void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        NullPointerException exception =
            assertThrows(NullPointerException.class, () -> detentionEngagementTeamEndAppealPersonalisation.getPersonalisationForLink((AsylumCase) null));
