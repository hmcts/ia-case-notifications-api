...
class RespondentNonStandardDirectionPersonalisationTest {
    ...
    void should_throw_exception_if_current_visible_state_to_home_office_all_is_not_present() {
        ...
        IllegalStateException exception =
            assertThrows(IllegalStateException.class, () -> respondentNonStandardDirectionPersonalisation.getRecipientsList(asylumCase));
    ...
    void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        NullPointerException exception =
            assertThrows(NullPointerException.class, () -> respondentNonStandardDirectionPersonalisation.getPersonalisation((AsylumCase) null));
    ...
    void should_throw_exception_on_personalisation_when_direction_is_empty() {
        ...
        IllegalStateException exception =
            assertThrows(IllegalStateException.class, () -> respondentNonStandardDirectionPersonalisation.getPersonalisation(asylumCase));
