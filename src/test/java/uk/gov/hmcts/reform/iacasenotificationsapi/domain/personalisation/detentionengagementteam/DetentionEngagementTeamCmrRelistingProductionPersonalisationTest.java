...
class DetentionEngagementTeamCmrRelistingProductionPersonalisationTest {
    ...
    private DetentionEngagementTeamCmrRelistingProductionPersonalisation personalisation;

    @BeforeEach
    public void setup() {
        personalisation = new DetentionEngagementTeamCmrRelistingProductionPersonalisation(
                templateId,
    ...
    void should_return_given_reference_id() {
        Long caseId = 12345L;
        assertEquals(caseId + "_DETAINED_CMR_RE_LISTING_PRODUCTION_DET", personalisation.getReferenceId(caseId));
    }
