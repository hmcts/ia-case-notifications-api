...
class LegalRepresentativeBailSignedDecisionNoticeUploadedPersonalisationTest {
    ...
    public void should_throw_exception_when_cannot_find_email_address_for_legal_rep() {
        ...
        IllegalStateException exception =
            assertThrows(IllegalStateException.class, () -> legalRepresentativeBailSignedDecisionNoticeUploadedPersonalisation.getRecipientsList(bailCase));
