...
public class RespondentFtpaSubmittedPersonalisationTest {
    ...
    @Before
    public void setup() {
        respondentFtpaSubmittedPersonalisation = new RespondentFtpaSubmittedPersonalisation(govNotifyTemplateIdConfiguration, personalisationProvider, respondentEmailAddress);
    }
    ...
    public void should_return_given_template_id() {
        ...
        when(govNotifyTemplateIdConfiguration.getFtpaSubmittedAllTemplateId()).thenReturn("ftpa-template-id");
        assertEquals(govNotifyTemplateIdConfiguration.getFtpaSubmittedAllTemplateId(), respondentFtpaSubmittedPersonalisation.getTemplateId());
    }
