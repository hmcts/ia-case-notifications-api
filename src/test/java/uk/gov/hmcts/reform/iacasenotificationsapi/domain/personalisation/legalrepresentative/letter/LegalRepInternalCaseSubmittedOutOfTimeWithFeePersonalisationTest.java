...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.legalrepresentative.letter.LegalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisation;
...
class LegalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisationTest {
    ...
    private LegalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisation legalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisationTest;
    ...
    public void setup() {
        ...
        legalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisationTest = new LegalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisation(
            letterTemplateId,
    ...
    void should_return_given_template_id() {
        assertEquals(letterTemplateId, legalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisationTest.getTemplateId());
    }

    @Test
    void should_return_given_reference_id() {
        assertEquals(ccdCaseId + "_INTERNAL_SUBMIT_APPEAL_WITH_FEE_OUT_OF_TIME_LEGAL_REP_LETTER",
                legalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisationTest.getReferenceId(ccdCaseId));
    }

    @Test
    void should_return_address_in_correct_format_legalRep_in_country() {
        legalRepInCountryDataSetup();
        assertTrue(legalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisationTest.getRecipientsList(asylumCase).contains("50_Buildingname_Streetname_Townname_XX12YY"));
    }

    @Test
    void should_return_address_in_correct_format_legalRep_out_of_country() {
        legalRepOutOfCountryDataSetup();
        assertTrue(legalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisationTest.getRecipientsList(asylumCase).contains("50_Buildingname_Streetname_Townname_Spain"));
    }
    ...
    void should_throw_exception_when_cannot_find_address_for_legalRep_in_country() {
        ...
        assertThatThrownBy(() -> legalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisationTest.getRecipientsList(asylumCase))
    ...
    void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        assertThatThrownBy(
            () -> legalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisationTest.getPersonalisation((Callback<AsylumCase>) null))
    ...
    void should_return_personalisation_when_all_information_given_appellant_in_country() {
        ...
        Map<String, String> personalisation =
                legalRepInternalCaseSubmittedOutOfTimeWithFeePersonalisationTest.getPersonalisation(callback);
