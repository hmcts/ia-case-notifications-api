...
class LegalRepresentativeCompleteCaseReviewStatutoryTimeframe24WeeksPersonalisationTest {
    ...
    private static final String EXPECTED_REFERENCE_ID =
            CASE_ID + "_STATUTORY_TIMEFRAME_24WEEKS_CASE_REVIEW_LEGAL_REP_EMAIL";
    @Mock
    ...
    private LegalRepresentativeCompleteCaseReviewStatutoryTimeframe24WeeksPersonalisation personalisation;
