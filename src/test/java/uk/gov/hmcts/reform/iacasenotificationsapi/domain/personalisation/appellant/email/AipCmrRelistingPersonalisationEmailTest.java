...
public class AipCmrRelistingPersonalisationEmailTest {
    ...
    private AipCmrRelistingPersonalisationEmail aipCmrRelistingPersonalisationEmail;

    @BeforeEach
    public void setUp() {
        aipCmrRelistingPersonalisationEmail = new AipCmrRelistingPersonalisationEmail(
                inPersonTemplateId,
                remoteTemplateId,
                iaAipFrontendUrl,
        ...
        org.springframework.test.util.ReflectionTestUtils.setField(aipCmrRelistingPersonalisationEmail, "adaPrefix", adaPrefix);
        org.springframework.test.util.ReflectionTestUtils.setField(aipCmrRelistingPersonalisationEmail, "nonAdaPrefix", nonAdaPrefix);
    }
    ...
    public void should_return_in_person_template_id_when_not_remote_hearing() {
        ...
        assertEquals(inPersonTemplateId, aipCmrRelistingPersonalisationEmail.getTemplateId(asylumCase));
    }
    ...
    public void should_return_remote_template_id_when_remote_hearing() {
        ...
        assertEquals(remoteTemplateId, aipCmrRelistingPersonalisationEmail.getTemplateId(asylumCase));
    }
    ...
    public void should_return_correct_reference_id() {
        assertEquals(caseId + "_CMR_RELISTED_OR_REMOTE_APPELLANT_EMAIL",
                aipCmrRelistingPersonalisationEmail.getReferenceId(caseId));
    }
    ...
    public void should_return_recipients_for_aip_journey() {
        ...
        Set<String> recipients = aipCmrRelistingPersonalisationEmail.getRecipientsList(asylumCase);
    ...
    public void should_throw_exception_when_asylum_case_is_null_for_recipients() {
        assertThrows(NullPointerException.class,
                () -> aipCmrRelistingPersonalisationEmail.getRecipientsList(null));
    }
    ...
    public void should_return_personalisation_when_all_information_given() {
        ...
        Map<String, String> personalisation = aipCmrRelistingPersonalisationEmail.getPersonalisation(asylumCase);
    ...
    public void should_throw_exception_when_asylum_case_is_null_for_personalisation() {
        NullPointerException exception = assertThrows(NullPointerException.class,
                () -> aipCmrRelistingPersonalisationEmail.getPersonalisation((AsylumCase) null));
