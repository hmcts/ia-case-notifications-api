...
class DetentionEngagementTeamAdjournHearingWithoutDateProductionPersonalisationTest {
    ...
    private DetentionEngagementTeamAdjournHearingWithoutDateProductionPersonalisation personalisation;
    ...
    @BeforeEach
    void setUp() {
        personalisation = new DetentionEngagementTeamAdjournHearingWithoutDateProductionPersonalisation(
    ...
    void should_return_reference_id() {
        assertThat(personalisation.getReferenceId(12345L))
                .isEqualTo("12345_DETAINED_CASE_ADJOURNED_HEARING_WITHOUT_DATE_PRODUCTION_DET");
    }
