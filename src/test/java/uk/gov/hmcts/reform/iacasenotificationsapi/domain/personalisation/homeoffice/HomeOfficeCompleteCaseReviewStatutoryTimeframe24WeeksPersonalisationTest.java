...
class HomeOfficeCompleteCaseReviewStatutoryTimeframe24WeeksPersonalisationTest {
    ...
    private static final String EXPECTED_REFERENCE_ID = CASE_ID + STATUTORY_TIMEFRAME_24WEEKS_CASE_REVIEW_HOME_OFFICE_EMAIL;
    @Mock
    ...
    private HomeOfficeCompleteCaseReviewStatutoryTimeframe24WeeksPersonalisation personalisation;
