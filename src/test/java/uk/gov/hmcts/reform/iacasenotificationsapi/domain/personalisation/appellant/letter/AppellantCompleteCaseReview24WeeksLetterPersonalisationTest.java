...
class AppellantCompleteCaseReview24WeeksLetterPersonalisationTest {
    ...
    private AppellantCompleteCaseReview24WeeksLetterPersonalisation personalisation;

    @BeforeEach
    void setUp() {
        personalisation = new AppellantCompleteCaseReview24WeeksLetterPersonalisation(
            TEMPLATE_ID,
    ...
    void should_return_reference_id() {
        ...
        assertEquals(CASE_ID + "_STATUTORY_TIMEFRAME_24WEEKS_CASE_REVIEW_APPELLANT_LETTER", reference);
    }
