...
class LegalRepresentativeCmrHearingCancelledPersonalisationTest {
    ...
    private LegalRepresentativeCmrHearingCancelledPersonalisation personalisation;
    ...
    @BeforeEach
    void setUp() {
        personalisation = new LegalRepresentativeCmrHearingCancelledPersonalisation(
    ...
    void should_return_reference_id() {
        assertThat(personalisation.getReferenceId(12345L))
                .isEqualTo("12345_CMR_HEARING_CANCELLED_LEGAL_REPRESENTATIVE");
    }
