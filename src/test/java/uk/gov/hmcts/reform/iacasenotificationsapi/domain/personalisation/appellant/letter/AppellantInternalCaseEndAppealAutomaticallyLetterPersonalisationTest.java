...
class AppellantInternalCaseEndAppealAutomaticallyLetterPersonalisationTest {
    ...
    private final int fourteenDaysDeadline = 14;
    @Mock
    ...
    void should_return_address_in_correct_format_appellant_in_country() {
        ...
        assertTrue(appellantInternalCaseEndAppealAutomaticallyLetterPersonalisation.getRecipientsList(asylumCase)
    ...
    void should_return_address_in_correct_format_appellant_out_of_country() {
        ...
        assertTrue(appellantInternalCaseEndAppealAutomaticallyLetterPersonalisation.getRecipientsList(asylumCase).contains("someAppellantGivenNamessomeAppellantFamil_50_Buildingname_Streetname_Townname_Spain"));
    }
    ...
    void should_throw_exception_when_cannot_find_address_for_appellant_in_country() {
        ...
        IllegalStateException exception =
            assertThrows(IllegalStateException.class, () -> appellantInternalCaseEndAppealAutomaticallyLetterPersonalisation.getRecipientsList(asylumCase));
    ...
    void should_return_personalisation_when_all_information_given_appellant_in_country() {
        ...
        assertThat(personalisation)
            .containsEntry("reinstateDeadlineDate", systemDateProvider.dueDate(fourteenDaysDeadline))
