...
class LegalRepresentativeBailCaseListingPersonalisationTest {
    ...
    private final String bailHearingLocation = "Yarl’s Wood\n" +
    ...
    public void should_throw_exception_when_cannot_find_email_address_for_legal_rep() {
        ...
        IllegalStateException exception =
            assertThrows(IllegalStateException.class, () -> legalRepresentativeBailCaseListingPersonalisation.getRecipientsList(bailCase));
    ...
    public void should_return_personalisation_when_all_information_given() {
        ...
        assertThat(personalisation)
            ...
            .containsEntry("hearingCentre", bailHearingLocation);
    }
