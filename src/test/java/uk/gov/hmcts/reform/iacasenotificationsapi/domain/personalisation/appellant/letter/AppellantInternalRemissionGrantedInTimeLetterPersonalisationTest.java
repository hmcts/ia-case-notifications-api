...
class AppellantInternalRemissionGrantedInTimeLetterPersonalisationTest {
    ...
    void should_return_appellant_address_in_correct_format() {
        ...
        assertTrue(appellantInternalRemissionGrantedInTImeLetterPersonalisation.getRecipientsList(asylumCase)
    ...
    void should_throw_exception_when_cannot_find_address_for_appellant_in_country() {
        ...
        IllegalStateException exception =
            assertThrows(IllegalStateException.class, () -> appellantInternalRemissionGrantedInTImeLetterPersonalisation.getRecipientsList(asylumCase));
