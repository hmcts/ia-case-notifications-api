...
class AppellantInternalAdminCaseListedPersonalisationTest {
    ...
    private String hearingLocation = "somehearingLocation";
    ...
    private AppellantInternalAdminCaseListedPersonalisation appellantInternalAdminCaseListedPersonalisation;
    ...
    public void setup() {
        ...
        appellantInternalAdminCaseListedPersonalisation = new AppellantInternalAdminCaseListedPersonalisation(
            letterTemplateId,
    ...
    void should_return_given_template_id() {
        assertEquals(letterTemplateId, appellantInternalAdminCaseListedPersonalisation.getTemplateId());
    }

    @Test
    void should_return_given_reference_id() {
        assertEquals(ccdCaseId + "_INTERNAL_CASE_LISTED_APPELLANT_LETTER",
            appellantInternalAdminCaseListedPersonalisation.getReferenceId(ccdCaseId));
    }

    @Test
    void should_return_address_in_correct_format() {
        assertTrue(appellantInternalAdminCaseListedPersonalisation.getRecipientsList(asylumCase).contains("50_Buildingname_Streetname_Townname_XX12YY"));
    }
    ...
    void should_throw_exception_when_cannot_find_address_for_appellant() {
        ...
        assertThatThrownBy(() -> appellantInternalAdminCaseListedPersonalisation.getRecipientsList(asylumCase))
    ...
    void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        assertThatThrownBy(
            () -> appellantInternalAdminCaseListedPersonalisation.getPersonalisation((Callback<AsylumCase>) null))
    ...
    void should_return_personalisation_when_all_information_given() {
        ...
        Map<String, String> personalisation =
            appellantInternalAdminCaseListedPersonalisation.getPersonalisation(callback);

        assertEquals(appellantGivenNames, personalisation.get("appellantGivenNames"));
        assertEquals(appellantFamilyName, personalisation.get("appellantFamilyName"));
        assertEquals(appealReferenceNumber, personalisation.get("appealReferenceNumber"));
        assertEquals(homeOfficeRefNumber, personalisation.get("homeOfficeReferenceNumber"));
        assertEquals(hearingLocation, personalisation.get("hearingLocation"));
