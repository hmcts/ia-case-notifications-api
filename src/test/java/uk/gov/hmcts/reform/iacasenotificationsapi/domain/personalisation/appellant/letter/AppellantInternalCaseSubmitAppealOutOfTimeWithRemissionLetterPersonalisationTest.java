...
class AppellantInternalCaseSubmitAppealOutOfTimeWithRemissionLetterPersonalisationTest {
    ...
    void should_return_address_in_correct_format_appellant_in_country() {
        ...
        assertTrue(appellantInternalCaseSubmitAppealOutOfTimeWithRemissionLetterPersonalisation.getRecipientsList(asylumCase).contains("appellantGivenNamesappellantFamilyName_50_Buildingname_Streetname_Townname_XX12YY"));
    }

    @Test
    void should_return_address_in_correct_format_appellant_out_of_country() {
        appellantOutOfCountryDataSetup();
        assertTrue(appellantInternalCaseSubmitAppealOutOfTimeWithRemissionLetterPersonalisation.getRecipientsList(asylumCase).contains("appellantGivenNamesappellantFamilyName_50_Buildingname_Streetname_Townname_Spain"));
    }
