...
public class LegalRepresentativeFtpaSubmittedPersonalisationTest {
    ...
    public void setUp() {
        ...
        when(govNotifyTemplateIdConfiguration.getFtpaSubmittedAllTemplateId()).thenReturn(templateId);

        legalRepresentativeFtpaSubmittedPersonalisation = new LegalRepresentativeFtpaSubmittedPersonalisation(govNotifyTemplateIdConfiguration, personalisationProvider);
    }
