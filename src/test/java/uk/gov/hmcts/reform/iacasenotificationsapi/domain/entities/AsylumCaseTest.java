...
public class AsylumCaseTest {
    ...
    public void current_case_state_visible_to_case_officer_flag_is_mutable() {
        ...
        asylumCase.setCurrentCaseStateVisibleToCaseOfficer(State.CASE_BUILDING);
        assertEquals(Optional.of(State.CASE_BUILDING), asylumCase.getCurrentCaseStateVisibleToCaseOfficer());
    ...
    public void current_case_state_visible_to_legal_representative_flag_is_mutable() {
        ...
        asylumCase.setCurrentCaseStateVisibleToLegalRepresentative(State.CASE_BUILDING);
        assertEquals(Optional.of(State.CASE_BUILDING), asylumCase.getCurrentCaseStateVisibleToLegalRepresentative());
