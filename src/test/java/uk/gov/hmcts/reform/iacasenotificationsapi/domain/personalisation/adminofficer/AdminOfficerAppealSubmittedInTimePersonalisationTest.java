...
class AdminOfficerAppealSubmittedInTimePersonalisationTest {
    ...
    private AdminOfficerAppealSubmittedInTimePersonalisation adminOfficerAppealSubmittedInTimePersonalisation;

    AdminOfficerAppealSubmittedInTimePersonalisationTest() {
    }

    @BeforeEach
    void setup() throws NotificationClientException, IOException {
        adminOfficerAppealSubmittedInTimePersonalisation = new AdminOfficerAppealSubmittedInTimePersonalisation(
    ...
    void should_return_given_reference_id() {
        assertEquals(caseId + "_INTERNAL_NON_ADA_APPEAL_SUBMITTED",
                adminOfficerAppealSubmittedInTimePersonalisation.getReferenceId(caseId));
    }
    ...
    void should_return_given_det_email_address() {
        ...
        assertTrue(
                adminOfficerAppealSubmittedInTimePersonalisation.getRecipientsList(asylumCase).contains(detentionEngagementTeamEmail));
    }

    @Test
    public void should_return_empty_set_email_address_from_asylum_case_no_detention_facility() {
        when(asylumCase.read(DETENTION_FACILITY, String.class)).thenReturn(Optional.empty());
        assertEquals(Collections.emptySet(), adminOfficerAppealSubmittedInTimePersonalisation.getRecipientsList(asylumCase));
    }
    ...
    void should_return_personalisation_of_all_information() throws NotificationClientException, IOException {
        Map<String, Object> personalisation = adminOfficerAppealSubmittedInTimePersonalisation.getPersonalisationForLink(asylumCase);
    ...
    public void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        assertThatThrownBy(() -> adminOfficerAppealSubmittedInTimePersonalisation.getPersonalisationForLink((AsylumCase) null))
    ...
    public void should_throw_exception_when_appeal_submission_is_empty() {
        ...
        assertThatThrownBy(() -> adminOfficerAppealSubmittedInTimePersonalisation.getPersonalisationForLink(asylumCase))
