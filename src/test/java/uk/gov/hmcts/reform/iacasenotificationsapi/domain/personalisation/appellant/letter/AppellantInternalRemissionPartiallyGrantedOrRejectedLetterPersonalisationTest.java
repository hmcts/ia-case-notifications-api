...
class AppellantInternalRemissionPartiallyGrantedOrRejectedLetterPersonalisationTest {
    ...
    public void setup() {
        ...
        String originalFeeAmount = "18000";
    ...
    void should_throw_exception_when_cannot_find_address_for_appellant_in_country() {
        ...
        IllegalStateException exception =
            assertThrows(IllegalStateException.class, () -> appellantInternalRemissionPartiallyGrantedOrRejectedLetterPersonalisation.getRecipientsList(asylumCase));
