...
class AppellantInternalCaseSubmitAppealWithRemissionLetterPersonalisationTest {
    ...
    void should_return_address_in_correct_format_appellant_in_country() {
        ...
        assertTrue(appellantInternalCaseSubmitAppealWithRemissionLetterPersonalisation.getRecipientsList(asylumCase)
    ...
    void should_throw_exception_when_cannot_find_address_for_appellant_in_country() {
        ...
        IllegalStateException exception =
            assertThrows(IllegalStateException.class, () -> appellantInternalCaseSubmitAppealWithRemissionLetterPersonalisation.getRecipientsList(asylumCase));
    ...
    void should_return_personalisation_when_all_information_given_appellant_in_country() {
        ...
        assertThat(personalisation)
            .containsEntry("tenDaysAfterSubmitDate", systemDateProvider.dueDate(10))
