...
class DetentionEngagementTeamCmrRelistingPersonalisationTest {
    final DocumentWithMetadata caseListedDoc = TestUtils.getDocumentWithMetadata(
            "id", "detained-appellant-cmr-relisting-letter", "some other desc", DocumentTag.INTERNAL_CMR_RE_LISTING_LETTER_BUNDLE);
    ...
    private DetentionEngagementTeamCmrRelistingPersonalisation detentionEngagementTeamCmrRelistingPersonalisation;

    DetentionEngagementTeamCmrRelistingPersonalisationTest() {
    }
    ...
    public void setup() throws NotificationClientException, IOException {
        ...
        detentionEngagementTeamCmrRelistingPersonalisation = new DetentionEngagementTeamCmrRelistingPersonalisation(
                templateId,
    ...
    public void should_return_given_template_id_detained() {
        assertEquals(
                templateId,
                detentionEngagementTeamCmrRelistingPersonalisation.getTemplateId()
        );
    }
    ...
    void should_return_given_reference_id() {
        Long caseId = 12345L;
        assertEquals(caseId + "_INTERNAL_DETAINED_CMR_RE_LISTING_DET",
                detentionEngagementTeamCmrRelistingPersonalisation.getReferenceId(caseId));
    }
    ...
    void should_return_given_det_email_address() {
        ...
        assertTrue(
                detentionEngagementTeamCmrRelistingPersonalisation.getRecipientsList(asylumCase).contains(detentionEngagementTeamEmail));
    }
    ...
    void getRecipientsList_should_return_empty_set_if_not_in_detention() {
        ...
        assertEquals(Collections.emptySet(), detentionEngagementTeamCmrRelistingPersonalisation.getRecipientsList(asylumCase));
    }
    ...
    public void should_return_personalisation_when_all_information_given() {
        ...
        Map<String, Object> actualPersonalisation =
                detentionEngagementTeamCmrRelistingPersonalisation.getPersonalisationForLink(asylumCase);
    ...
    public void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        NullPointerException exception =
                assertThrows(NullPointerException.class, () -> detentionEngagementTeamCmrRelistingPersonalisation.getPersonalisationForLink((AsylumCase) null));
    ...
    public void should_throw_exception_when_notification_client_throws_Exception() throws NotificationClientException, IOException {
        ...
        IllegalStateException exception =
                assertThrows(IllegalStateException.class, () -> detentionEngagementTeamCmrRelistingPersonalisation.getPersonalisationForLink(asylumCase));
        assertEquals("Failed to get Internal detained CMR relisting letter in compatible format", exception.getMessage());
    }
}
