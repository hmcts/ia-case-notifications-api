...
import uk.gov.hmcts.reform.iacasenotificationsapi.domain.personalisation.legalrepresentative.LegalRepresentativeAppealSubmittedLateWithFeePersonalisation;
...
class LegalRepAppealSubmittedOutOfTimeWithFeePersonalisationTest {
    ...
    private LegalRepresentativeAppealSubmittedLateWithFeePersonalisation legalRepCaseSubmittedOutOfTimeWithFeePersonalisation;
    ...
    public void setup() {
        ...
        legalRepCaseSubmittedOutOfTimeWithFeePersonalisation = new LegalRepresentativeAppealSubmittedLateWithFeePersonalisation(
            letterTemplateId,
    ...
    void should_return_given_template_id() {
        assertEquals(letterTemplateId, legalRepCaseSubmittedOutOfTimeWithFeePersonalisation.getTemplateId());
    }

    @Test
    void should_return_given_reference_id() {
        assertEquals(ccdCaseId + "_LEGAL_REP_MANUAL_APPEAL_SUBMITTED_OUT_OF_TIME_WITH_FEE_LETTER",
                legalRepCaseSubmittedOutOfTimeWithFeePersonalisation.getReferenceId(ccdCaseId));
    }
    ...
    void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        assertThatThrownBy(
            () -> legalRepCaseSubmittedOutOfTimeWithFeePersonalisation.getPersonalisation((Callback<AsylumCase>) null))
    ...
    void should_return_personalisation_when_all_information_given_appellant_in_country() {
        ...
        Map<String, String> personalisation =
                legalRepCaseSubmittedOutOfTimeWithFeePersonalisation.getPersonalisation(callback);
