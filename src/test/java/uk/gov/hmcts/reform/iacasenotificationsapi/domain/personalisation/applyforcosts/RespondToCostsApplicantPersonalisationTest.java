...
class RespondToCostsApplicantPersonalisationTest {
    ...
    void should_return_given_email_address(List<IdValue<ApplyForCosts>> applyForCostsList, DynamicList respondsToCostsList) {
        ...
        if (applyForCostsList.getFirst().getValue().getApplyForCostsApplicantType().equals("Tribunal")) {
            assertTrue(respondToCostsApplicantPersonalisation.getRecipientsList(asylumCase).isEmpty());
        } else if (applyForCostsList.getFirst().getValue().getApplyForCostsApplicantType().equals(homeOffice)) {
    ...
    void should_throw_exception_on_personalisation_when_case_is_null() {
        ...
        NullPointerException exception =
            assertThrows(NullPointerException.class, () -> respondToCostsApplicantPersonalisation.getPersonalisation((AsylumCase) null));
