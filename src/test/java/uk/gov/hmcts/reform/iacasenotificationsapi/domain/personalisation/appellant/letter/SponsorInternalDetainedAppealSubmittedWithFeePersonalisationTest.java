...
class SponsorInternalDetainedAppealSubmittedWithFeePersonalisationTest {
    ...
    private SponsorInternalDetainedAppealSubmittedWithFeePersonalisation sponsorInternalDetainedAppealSubmittedWithFeePersonalisation;
    ...
    void setup() {
        ...
        sponsorInternalDetainedAppealSubmittedWithFeePersonalisation = new SponsorInternalDetainedAppealSubmittedWithFeePersonalisation(
            letterTemplateId,
    ...
    void should_return_given_template_id() {
        assertEquals(letterTemplateId, sponsorInternalDetainedAppealSubmittedWithFeePersonalisation.getTemplateId());
    }

    @Test
    void should_return_given_reference_id() {
        assertEquals(ccdCaseId + "_INTERNAL_SUBMIT_APPEAL_WITH_FEE_SPONSOR_LETTER",
            sponsorInternalDetainedAppealSubmittedWithFeePersonalisation.getReferenceId(ccdCaseId));
    }

    @Test
    void should_return_sponsor_address_in_correct_format() {
        assertTrue(sponsorInternalDetainedAppealSubmittedWithFeePersonalisation.getRecipientsList(asylumCase).contains("50_Buildingname_Streetname_Townname_XX12YY"));
    }
    ...
    void should_throw_exception_when_cannot_find_sponsor_address() {
        ...
        assertThatThrownBy(() -> sponsorInternalDetainedAppealSubmittedWithFeePersonalisation.getRecipientsList(asylumCase))
    ...
    void should_throw_exception_on_personalisation_when_callback_is_null() {
        ...
        assertThatThrownBy(
            () -> sponsorInternalDetainedAppealSubmittedWithFeePersonalisation.getPersonalisation((Callback<AsylumCase>) null))
    ...
    void should_return_personalisation_when_all_information_given() {
        ...
        Map<String, String> personalisation =
            sponsorInternalDetainedAppealSubmittedWithFeePersonalisation.getPersonalisation(callback);
