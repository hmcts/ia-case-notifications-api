...
public class DetentionEngagementTeamRequestResponseReviewPersonalisationTest {
    ...
    public void setUp() throws NotificationClientException, IOException {
        ...
        List<IdValue<DocumentWithMetadata>> appealResponseDocuments = getDocumentWithMetadata("docId", "filename", "description");
    ...
    private static List<IdValue<DocumentWithMetadata>> getDocumentWithMetadata(String docId, String filename,
                                                String description) {
        String documentUrl = "http://dm-store/" + docId;
        Document document = new Document(documentUrl, documentUrl + "/binary", filename);
        List<IdValue<DocumentWithMetadata>> res = Arrays.asList(new IdValue<>(docId, new DocumentWithMetadata(document, description,
            LocalDate.now().toString(), DocumentTag.APPEAL_RESPONSE)));
